...
public class 业务活动表Page extends Handler {
	 ...
	 * 查询
	 */
	public void search(String date, String company, boolean 包含未记账凭证) throws InterruptedException, MyException {

		switchToDefaultContent();
		switchToFrame(getWebElement("业务活动表iframe"));
