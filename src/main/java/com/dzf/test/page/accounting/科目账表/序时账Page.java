...
public class 序时账Page extends Handler {
	...
	public void search(String beginDate, String endDate, String attribute, String subject1, String subject2,
			String minlevel, String maxlevel, String currency, boolean 包含未记账凭证, boolean 只查询末级科目, String company)
			throws InterruptedException, MyException {

		switchToDefaultContent();
		switchToFrame(getWebElement("序时账iframe"));
