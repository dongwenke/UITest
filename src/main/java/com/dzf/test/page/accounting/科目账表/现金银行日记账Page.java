...
public class 现金银行日记账Page extends Handler {

	
	public 现金银行日记账Page() {
		super();
		try {
			page = XMLUtil.convert("./config/page/accounting/科目帐表/"+this.getClass().getSimpleName()+".xml", Page.class.getName());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void search(String beginDate, String endDate, String attribute, String subject1, String subject2,
		...
		switchToFrame(getWebElement("现金/银行日记账iframe"));
