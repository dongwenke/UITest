...
public class 增值税和营业税月度申报对比表Page extends Handler {

	public 增值税和营业税月度申报对比表Page() {
		super();
		try {
	 ...
	 * 查询
	 */
	public void search(String date, String company) throws InterruptedException, MyException {

		switchToDefaultContent();
		switchToFrame(getWebElement("增值税和营业税月度申报对比表iframe"));
